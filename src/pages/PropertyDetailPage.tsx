...
const PropertyDetailPage = () => {
  ...
  const { addToFavorites, removeFromFavorites, isPropertyFavorite } = useAuth();
            ...
            <div className="lg:col-span-2 space-y-8">
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
                ...
                <div className="bg-white dark:bg-gray-800 p-4 rounded-lg shadow-sm text-center">
                  ...
                  <p className="text-xs text-muted-foreground mt-1">By {property.agent.name}</p>
                </div>
              </div>
                ...
                <Tabs defaultValue="location">
                  ...
                  <TabsContent value="location" className="p-0">
                    <div className="aspect-video relative">
                      <iframe 
                        src={`https://maps.google.com/maps?q=${encodeURIComponent(property.location.address)}&t=&z=13&ie=UTF8&iwloc=&output=embed`}
                ...
                <CardContent className="p-6">
                  ...
                  <div className="space-y-4">
                    <ContactForm 
                      ...
                      receiverName={property.agent.name}
