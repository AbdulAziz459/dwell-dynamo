...
const MessageList = () => {
  ...
  const conversations = messages.reduce((acc, message) => {
    ...
    if (!acc[otherUserId]) {
      acc[otherUserId] = {
        otherUserId,
        otherUserName: message.senderId === user?.id ? message.receiverName : message.senderName,
        otherUserImage: message.senderId === user?.id ? message.receiverImage : message.senderImage,
        messages: [],
